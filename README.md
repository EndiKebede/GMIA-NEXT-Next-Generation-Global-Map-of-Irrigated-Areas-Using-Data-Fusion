...
GMIA-NEXT is a high-resolution (30-meter) global map of irrigated areas for the 2023/24 growing season. It integrates multi-source remote sensing, machine learning, and agricultural statistics to generate an improved, next-generation representation of current irrigated extent.
...
1. `data/` Directory  
   Contains input datasets used throughout the GMIA-NEXT workflow, including ancillary spatial data and curated ground-truth samples.
...
The code exports processed predictor variables on a country-level or sub-national basis for efficient use. Scripts can easily be adapted for large-scale processing.
...
- Continental model training with country prediction 
- Feature engineering  
